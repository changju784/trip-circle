                        ...
                        <div key={doc._id} className="flex flex-col gap-2 p-4 border dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 transition-colors hover:border-gray-300 dark:hover:border-gray-600">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    {/* CONSOLIDATED PARSE/RE-PARSE BUTTON */}
                                    ...
                                    <div className="flex gap-2 items-start">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-xs font-bold text-indigo-900 dark:text-indigo-200">
                                                AI Suggestion: {doc.extractedData?.vendor || "Unknown Vendor"}
                                            </p>
                                            <p className="text-[10px] text-indigo-700 dark:text-indigo-300 line-clamp-1">
                                                {doc.extractedData?.aiInsights?.reasoning || "Parsing complete. Check details for accuracy."}
                                            </p>
                                        </div>
                                    </div>
                                    <Button
                                        size="sm"
                                        className="h-7 px-3 text-[10px] bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm"
