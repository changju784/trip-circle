...
export default function Receipts({ tripId, receipts, onReceiptsChange }: ReceiptsProps) {
    ...
    const getFileIcon = (contentType: string) => {
        if (contentType.startsWith("image/")) {
            return <Image className="w-6 h-6 text-blue-600 dark:text-blue-400" />;
        }
    ...
    return (
        <div className="bg-white dark:bg-gray-700 border dark:border-gray-600 rounded-lg p-6 mt-6">
            <div className="flex items-center justify-between mb-4">
                <div>
                    <h3 className="text-lg text-black dark:text-gray-100 font-semibold">Receipts & Documents</h3>
            ...
            {/* Upload Section */}
            <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-600 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-500">
            ...
            <div className="space-y-3">
                {receipts.length === 0 ? (
                    ...
                    receipts.map((receipt) => (
                        <div
                            key={receipt.id}
                            className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-500 transition-colors"
                        >
                            ...
                            <div className="flex items-center gap-2 flex-shrink-0">
                                <a
                                    ...
                                    className="flex items-center gap-1 px-3 py-1.5 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-md transition-colors text-sm font-medium"
                                >
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 px-3 py-1.5 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-md transition-colors text-sm font-medium"
                                >
