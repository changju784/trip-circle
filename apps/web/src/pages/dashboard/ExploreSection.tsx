...
export default function ExploreSection() {
    ...
    // 2. RE-INSERT useEffect for loading posts...
    useEffect(() => {
        let cancelled = false;
                ...
                if (debouncedQuery) {
                    ...
                    if (!cancelled) {
                        setPosts(trips.map(trip => ({
                            ...
                            likes: [], comments: [], forkCount: 0, likeCount: 0, commentCount: 0,
    ...
    // 3. RE-INSERT handleLike & handleCommentSubmit ...
            ...
            {!isLoading && filteredPosts.length > 0 && (
                <div className="grid gap-4 md:grid-cols-3">
                    {filteredPosts.map((post) => {
                        ...
                        const isSearchItem = post._id.startsWith('trip-');
